...
//                     <p className="text-5xl font-bold text-[#7C3AED]">{Array.isArray(userResponse) ? userResponse[0]?.score : null}/100</p>
//                 </div>

//                 <div className="mb-6">
//                     <h2 className="text-2xl font-semibold text-gray-800 mb-3">Strengths</h2>
//                     <ul className="list-disc pl-5 space-y-2">
//                         {userResponse && Array.isArray(userResponse) && userResponse[0]?.strength?.map((item: string, index: number) => (
...
//                     <ul className="list-disc pl-5 space-y-2">
//                         {userResponse && Array.isArray(userResponse) && userResponse[0]?.weakness.map((item:any, index:any) => (
//                             <li key={index} className="text-gray-700">{item}</li>
//                         ))}
//                     </ul>
//                 </div>
...
//                     <p className="text-gray-700">{Array.isArray(userResponse) && userResponse[0]?.summary}</p>
//                 </div>
//             </div>
//         </div>
//     )
